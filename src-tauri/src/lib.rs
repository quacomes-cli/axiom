...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::commands::secret_set,
            ipc::commands::secret_get,
            ipc::commands::secret_delete,
            ...
            ipc::commands::docs_add,
            ipc::commands::docs_list,
            ipc::commands::docs_remove,
            ipc::commands::docs_count,
            ipc::commands::docs_search,
