...
### 4b — i18n — ALTYAPI + KROM TAMAMLANDI (2026-07-04)
...
- [ ] KALAN (kademeli): ChatPanel gövdesi, Profil/Kısayol/İzin/Updater sekmeleri,
      Apps/Tasks/Models/Telegram/Price sayfaları, GeneralSettings derin gövdeler
      (Alarm/Voice/Memory/TTS satırları). Altyapı hazır — her biri `useT()` + anahtar
      ekleyerek taşınır.
